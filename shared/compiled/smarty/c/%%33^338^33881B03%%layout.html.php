<?php /* Smarty version 2.6.31, created on 2022-03-28 08:11:02
         compiled from layout.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'layout.html', 32, false),)), $this); ?>
<!DOCTYPE html>
  ...
  <?php if (( $this->_tpl_vars['user_logged'] != '' || $this->_tpl_vars['tracker'] != '' ) && $this->_tpl_vars['timezone_status'] != 'failed'): ?>
    <body>
      <table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0" id="pm_main_table">
        <tr>
          <td id="pm_header" valign="top" <?php if ($this->_tpl_vars['user_logged'] != '' || $this->_tpl_vars['tracker'] != ''): ?>style="background-color: #16F529; border-bottom:1px solid #e7e7e7;"<?php endif; ?>>
...
<label class="textBlue"><?php echo $this->_tpl_vars['userfullname']; ?>
 <a href="../users/myInfo"><?php echo ((is_array($_tmp=$this->_tpl_vars['user'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</a> | </label>
...
" class="tableOption"><?php echo $this->_tpl_vars['logout']; ?>
 ...
 <b><u><?php echo ((is_array($_tmp=$this->_tpl_vars['workspace'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</u></b></label>&nbsp; &nbsp;
                      <?php else: ?>
